...
export class SkinService {
  ...
  getAll(): Observable<Response<Skin[]>> {
    return this.http.get<Response<Skin[]>>(`${this._baseUrl}api/Skins`);
  }
  ...
  getByCategory(categoryId: number): Observable<Response<Skin[]>> {
    return this.http.get<Response<Skin[]>>(`${this._baseUrl}api/Skins/by-category/${categoryId}`);
  }
